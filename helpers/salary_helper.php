...
function app_salary_pdf($type, $path, ...$params)
{
    ...
    // echo $path;
    // exit();
    $path =  module_dir_path('salary').'libraries'.'/pdf'.'/salary_pdf.php';
    // exit();
    include_once($path);
...
function salary_pdf_footer_logo()
{
    ...
    $logoUrl = module_dir_path('salary').'assets'.'/footer.png';
...
function staff_name($id){
    ...
    $staff = $CI->salary_model->getStaff($id, ['active' => 1]);
    return $staff->firstname.' '.$staff->lastname;
}
function image_phone()
{
    return module_dir_path('salary').'assets'.'/phone.png';
    // base_url().'index.php/login/verify';
}
function image_email()
{
    return module_dir_path('salary').'assets'.'/email.png';
}
function image_location()
{
    return module_dir_path('salary').'assets'.'/location.png';
