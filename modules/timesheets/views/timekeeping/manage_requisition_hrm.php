                          ...
                          <div class="col-md-12">
                            ...
                            <div id="list_jp">
                              ...
                              <?php echo render_textarea('advance_payment_reason','advance_payment_reason'); ?>
                                  ...
                                  <div class="row approx-fr mtop10">
                                   <div class="col-md-12">
                                    <?php  
                                        ...
                                        echo render_input('number_of_leaving_day', 'number_of_days',$value_number_day,'number',array('onblur' => 'get_date(this)','step'=>'0.5','min'=>'0.5','max'=>$number_day_off));
                                     ?>
                                   </div>
                                  ...
                                  <div class="row mtop10">
                                    <div class="col-md-6 pb-4" id="leave_">
                                      ...
                                      <div class="col-md-6 pb-4" id="leave_handover_recipients">
