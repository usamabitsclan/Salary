...
<?php if(isset($opprtunity)){ ?>
	<h4 class="customer-profile-group-heading"><?php echo _l('client_invoices_tab'); ?></h4>
	<?php if(has_permission('invoices','','create')){ ?>
		<a href="<?php echo admin_url('invoices/invoice?customer_id='.$opportunity->id); ?>" class="btn btn-info mbot15<?php if($client->active == 0){echo ' disabled';} ?>">
