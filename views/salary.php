            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php
                        if(isset($data))
                            echo form_open_multipart('salary/salaries/'.$data->id,array('id'=>'salaries'));
                        else
                            echo form_open_multipart('salary/salaries',array('id'=>'salaries'));
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                $value = isset($data) ? $data->basic_salary : '';
                                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <?php
                                $value = isset($data) ? $data->paid_leaves : '';
                                ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php
                                $value = isset($data) ? $data->unpaid_leaves : '';
                                ?>
